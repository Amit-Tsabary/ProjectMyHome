...
import com.example.amitproject11.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment implements View.OnClickListener, ButtonDisplay {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        TextView text = (TextView) view.findViewById(R.id.welcome);
    ...
    {
        LinearLayout layout = (LinearLayout)view.findViewById(R.id.button_layout);
